...
export default function Privacypolicy() {
    ...
    return (
        <div style={{ textAlign: "center", flexGrow: 1 }}>
            ...
            <div>
                <h2>At react-jobs.com, we’re committed to protecting and respecting your privacy.</h2>
                ...
                <p>Any questions regarding this Policy and our privacy practices should be sent by email to dpo@react-jobs.com</p>
            </div>
        </div>
